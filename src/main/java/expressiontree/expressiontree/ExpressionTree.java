...
public class ExpressionTree {
  ...
  private IteratorFactory treeIteratorFactory = new IteratorFactory();
  ...
  /** Returns an @a Iterator that supports the requested traveralOrder. */
  public Iterator<ExpressionTree> makeIterator(String traversalOrderRequest) {
     ...
     * iterator.
     */
    return treeIteratorFactory.makeIterator(this, traversalOrderRequest);
  }
}
