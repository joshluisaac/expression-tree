 ...
 *     object.
 *     <p>This class is a variant of the Abstract Factory pattern that has a set of related factory
 *     methods but which doesn't use inheritance.
 */
public class UninitializedStateFactory {
   ...
   * implementations.
   */
  private Map<String, State> uninitializedStateMap = new HashMap<>();
