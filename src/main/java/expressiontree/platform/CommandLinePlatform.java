...
public class CommandLinePlatform extends Platform {
  ...
  /** Ctor. */
  public CommandLinePlatform(Object input, Object output) {
    this.input = (InputStream) input;
    this.output = (PrintStream) output;
  }

  /** Retrieves input from console and returns the value as a string. */
  ...
  /**
   * Same as outputChar in commandLine platform, but serves separate purpose for android
   * implementation.
   */
