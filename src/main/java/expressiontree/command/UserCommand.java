...
/**
 * @class UserCommand
 * @brief Plays the role of the "Command" in the Command pattern to define an API for
 *     "ConcreteCommand" implementations that perform an operation on the expression tree when it's
 *     executed.
 */
