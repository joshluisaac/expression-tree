...
/**
 * @class PrintVisitor
 * @brief This class serves as a visitor that print the contents of each type of node in an
 *     expression tree. This class plays the role of the "ConcreteVisitor" in the Visitor pattern.
 */
