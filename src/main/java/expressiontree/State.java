...
/**
 * @class State
 * @brief Implementation of the State pattern that is used to define the various states that affect
 *     how users operations are processed. Plays the role of the "State" base class in the State
 *     pattern that is used as the basis for the subclasses that actually define the various states.
 */
public class State {
  ...
  /** Print the operators and operands of the @a tree using the designated @a traversalOrder. */
  static void printTree(ExpressionTree tree, String traversalOrder) {
    if (traversalOrder.equals(""))
      /** Default to in-order if user doesn't explicitly request a print order. */
      traversalOrder = "in-order";

    /**
     * Note the high pattern density in the code below, which uses of the Factory Method, Iterator,
     * Bridge, Strategy, and Visitor patterns.
     */
    ...
    /**
     * Iterate through all nodes in the expression tree and accept the printVisitor to print each
     * type of node.
     */
  ...
  /** Evaluate and print the yield of the @a tree using the designated @a traversalOrder. */
  static void evaluateTree(ExpressionTree tree, String traversalOrder) {
    if (traversalOrder.equals(""))
      /** Default to post-order if user doesn't explicitly request an eval order. */
    ...
    /**
     * Iterate through all nodes in the expression tree and accept the evalVisitor to evaluate each
     * type of node.
     */
    for (Iterator<ExpressionTree> it = tree.makeIterator(traversalOrder); it.hasNext(); )
  ...
  static class UninitializedState extends State {
     ...
     * @brief Implementation of a factory pattern that dynamically allocates the appropriate @a
     *     State object.
    ...
    static class UninitializedStateFactory {
       ...
       * implementations.
       */
      private HashMap<String, State> uninitializedStateMap = new HashMap<String, State>();
    ...
    static class InOrderUninitializedState extends UninitializedState {
      /**
       * Process the @a expression using an in-order interpreter and update the state of the @a
       * context to the @a InOrderInitializedState.
       */
      ...
      /**
       * Process the @a expression using a in-order interpreter and update the state of @a treeOps
    ...
    static class LevelOrderUninitializedState extends UninitializedState {
      ...
      /**
       * Process the @a expression using a level-order interpreter and update the state of the @a
       * context to the @a LevelOrderInitializedState.
       */
      void makeTree(TreeOps context, String expression) {
        throw new IllegalStateException(
            "LevelOrderUninitializedState.makeTree() not yet implemented");
      }
    }
    ...
    static class LevelOrderInitializedState extends LevelOrderUninitializedState {
      ...
      void evaluate(TreeOps context, String format) {
        throw new IllegalArgumentException(
            "LevelOrderInitializedState.evaluate() not yet implemented");
      }
    }
    ...
    static class PostOrderUninitializedState extends UninitializedState {
      ...
      /**
       * Process the @a expression using a post-order interpreter and update the state of the @a
       * context to the @a PostOrderInitializedState.
       */
      void makeTree(TreeOps context, String expression) {
        throw new IllegalStateException(
            "PostOrderUninitializedState.makeTree() not yet implemented");
      }
    }
    ...
    static class PostOrderInitializedState extends PostOrderUninitializedState {
      ...
      void evaluate(TreeOps context, String param) {
        throw new IllegalArgumentException(
            "PostOrderInitializedState.evaluate() not yet implemented");
      }
    }
    ...
    static class PreOrderUninitializedState extends UninitializedState {
      ...
      /**
       * Process the @a expression using a pre-order interpreter and update the state of the @a
       * context to the @a PreOrderUninitializedState.
       */
      void makeTree(TreeOps context, String format) {
        throw new IllegalStateException(
            "PreOrderUninitializedState.makeTree() not yet implemented");
      }
    }
    ...
    static class PreOrderInitializedState extends PreOrderUninitializedState {
      ...
      void evaluate(TreeOps context, String format) {
        throw new IllegalArgumentException(
            "PreOrderInitializedState.evaluate() not yet implemented");
      }
    }
  }
}
